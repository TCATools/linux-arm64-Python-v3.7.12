...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/usr/local/src/Python-3.7.12/coverage.info',
 'COVERAGE_REPORT': '/usr/local/src/Python-3.7.12/lcov-report',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/usr/local/src/Python-3.7.12',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/usr/local/src/Python-3.7.12 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/usr/local/src/Python-3.7.12 ./python '
 ...
 'abs_builddir': '/usr/local/src/Python-3.7.12',
 'abs_srcdir': '/usr/local/src/Python-3.7.12',
